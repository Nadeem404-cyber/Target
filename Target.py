...
def banner():
    ...
    print Y+" ╚═════╝░╚═╝╚══════╝╚═╝░░╚═╝╚══════╝"
    print GG+" √=============================================√"
    print GL+" ANOTHER:- BILAL HAIDER"
    print GL+" GMAIL:- bilalhaiderofficial007@gmail.com"
    print GG+" YOUTUBE:- BILAL TECH"
    print GL+" TYPE OF TOOL:- PASSWORD CRACKING"
    print GG+"  √=============================================√"

banner()

print wd+"         https://www.github.com/Bilal-XD "
print GG+"╭────\033[91m[\033[96m BILAL-XD\033[95m / \033[96mUsername Target\033[91m ] "
email_target = str(raw_input(GL+"\033[92m╰────➲\033[93m  "))
print " "
print "\033[92m╭────\033[91m[ \033[96mFile Wordlist \033[95m( pass.txt ) \033[91;1m]"
